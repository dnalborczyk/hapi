...
export default class Response {
    ...
    etag(tag, options) {
        ...
        const entity = Response.entity(tag, options);
    ...
    async _marshal() {
        ...
        this._payload = new Response.Payload(payload, this.settings);
    }
...
Response.Payload = class extends Stream.Readable {
...
Response.Peek = class extends Stream.Transform {
