...
export async function content (request) {
...
export function type (request, postMarshal) {
...
export function entity (request) {
...
export function unmodified (request) {
